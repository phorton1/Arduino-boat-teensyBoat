...
TODO: insert photo of teensyBoat device as installed on boat
...
my $path = "C:/src/Arduino/boat/teensyBoat/docs/readme.md";
open(my $out, '>:utf8', $path) or die "Cannot write $path: $!";
print $out $content;
close $out;
print "Written: $path\n";
